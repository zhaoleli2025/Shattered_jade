...
function rosterTemplates() {
  return [
    P("wang", "王铁枪", "枪", { hpMax: 55, skill: 62, def: 10, shield: 0, resolve: 48,
      ...
      wpn: { kind: "melee", label: "长枪", hands: 2, reach: 2, acc: 20, dmin: 22, dmax: 32, armorEff: 0.9, pierce: 0.3, ap: 6, br: 15, br_tax: 4, special: { type: "spearwall", label: "枪林", ap: 3, br: 18 } },
      wpn2: { kind: "melee", label: "腰刀", hands: 1, acc: 10, dmin: 18, dmax: 26, armorEff: 1.0, pierce: 0.3, ap: 4, br: 12, br_tax: 2, bleed: true, special: { type: "decap", label: "斩首", ap: 5, br: 15, dmgMult: 1.3 } } }),
    P("liu", "刘三刀", "刀", { hpMax: 60, skill: 60, def: 6, shield: 15, resolve: 45,
      initBase: 104, breathBase: 87, armor: "pijia", helmet: "pikui", wpn_q: "jing",
      wpn: { kind: "melee", label: "腰刀", hands: 1, acc: 10, dmin: 18, dmax: 26, armorEff: 1.0, pierce: 0.3, ap: 4, br: 12, br_tax: 2, bleed: true, special: { type: "decap", label: "斩首", ap: 5, br: 15, dmgMult: 1.3 } } }),
    P("shi", "石敢当", "锤", { hpMax: 65, skill: 58, def: 5, shield: 0, resolve: 50,
      initBase: 90, breathBase: 93, armor: "tiejia", helmet: "tiekui",
      wpn: { kind: "melee", label: "大锤", hands: 2, acc: 5, dmin: 28, dmax: 40, armorEff: 2.0, pierce: 0.2, ap: 6, br: 18, br_tax: 6, breathDrain: 20, special: { type: "demolish", label: "碎甲", ap: 6, br: 20, armorMult: 3.0 } } }),
    P("yan", "燕小乙", "弓", { hpMax: 45, skill: 56, def: 8, shield: 0, resolve: 42,
      initBase: 112, breathBase: 94, armor: "bujia", helmet: "bumao", wpn_q: "liang",
      wpn: { kind: "ranged", label: "猎弓", hands: 2, acc: 10, dmin: 14, dmax: 24, armorEff: 0.6, pierce: 0.35, ap: 4, br: 8, br_tax: 2, range: 7, falloff: 3, special: { type: "aimed", label: "瞄准", ap: 6, br: 12, accBonus: 10, falloff: 2 } },
      wpn2: { kind: "melee", label: "匕首", hands: 1, acc: -15, dmin: 14, dmax: 22, armorEff: 0.0, pierce: 1.0, ap: 4, br: 10, br_tax: 1, noHead: true } }),
    E("duyan", "独眼龙", "刀", { hpMax: 50, skill: 52, def: 4, shield: 0, resolve: 38,
      initBase: 100, breathBase: 89, armor: "bujia", helmet: "bumao",
      wpn: { kind: "melee", label: "砍刀", hands: 1, acc: 10, dmin: 17, dmax: 26, armorEff: 1.0, pierce: 0.3, ap: 4, br: 12, br_tax: 2, bleed: true, special: { type: "decap", label: "斩首", ap: 5, br: 15, dmgMult: 1.3 } } }),
    ...
    E("xiaohu", "笑面虎", "斧", { hpMax: 55, skill: 54, def: 4, shield: 0, resolve: 40,
      ...
      wpn: { kind: "melee", label: "大斧", hands: 2, acc: 5, dmin: 30, dmax: 44, armorEff: 1.3, pierce: 0.25, ap: 6, br: 16, br_tax: 5, chop: true, special: { type: "sweep", label: "横扫", ap: 6, br: 20, acc: -10 } } }),
    E("yemao", "夜猫子", "弓", { hpMax: 42, skill: 50, def: 6, shield: 0, resolve: 36,
      initBase: 108, breathBase: 91, armor: "bujia", helmet: "none_h",
      wpn: { kind: "ranged", label: "猎弓", hands: 2, acc: 10, dmin: 14, dmax: 24, armorEff: 0.6, pierce: 0.35, ap: 4, br: 8, br_tax: 2, range: 7, falloff: 3, special: { type: "aimed", label: "瞄准", ap: 6, br: 12, accBonus: 10, falloff: 2 } },
      wpn2: { kind: "melee", label: "短刀", hands: 1, acc: 0, dmin: 14, dmax: 22, armorEff: 0.8, pierce: 0.3, ap: 4, br: 10, br_tax: 1 } }),
    E("diao", "坐山雕", "首", { hpMax: 70, skill: 62, def: 12, shield: 15, resolve: 55,
      ...
      wpn: { kind: "melee", label: "九环刀", hands: 1, acc: 10, dmin: 24, dmax: 34, armorEff: 1.0, pierce: 0.3, ap: 4, br: 12, br_tax: 3, bleed: true, special: { type: "decap", label: "斩首", ap: 5, br: 15, dmgMult: 1.3 } } }),
    ...
    P("chen", "陈短矛", "矛", { hpMax: 58, skill: 58, def: 8, shield: 15, resolve: 46,
      ...
      wpn: { kind: "melee", label: "短矛", hands: 1, acc: 15, dmin: 16, dmax: 24, armorEff: 0.9, pierce: 0.25, ap: 4, br: 11, br_tax: 2, special: { type: "spearwall", label: "枪阵", ap: 3, br: 16 } } }),
    P("he", "何九鞭", "鞭", { hpMax: 52, skill: 57, def: 7, shield: 0, resolve: 44,
      initBase: 106, breathBase: 90, armor: "bujia", helmet: "pikui",
      wpn: { kind: "melee", label: "九节鞭", hands: 1, acc: 5, dmin: 18, dmax: 28, armorEff: 0.9, pierce: 0.3, ap: 4, br: 13, br_tax: 3, ignoreShield: true, headBonus: 10, special: { type: "headhunt", label: "兜头", ap: 5, br: 16, headMult: 2.0, acc: -15, missBr: 15 } } }),
    P("lu", "鲁大弩", "弩", { hpMax: 48, skill: 54, def: 6, shield: 0, resolve: 45,
      initBase: 95, breathBase: 89, armor: "pijia", helmet: "bumao",
      wpn: { kind: "ranged", label: "弩", hands: 2, acc: 15, dmin: 22, dmax: 32, armorEff: 0.8, pierce: 0.5, ap: 4, br: 10, br_tax: 4, range: 6, falloff: 2, special: { type: "aimed", label: "瞄准", ap: 6, br: 14, accBonus: 10, falloff: 1 } },
      wpn2: { kind: "melee", label: "短刀", hands: 1, acc: 0, dmin: 14, dmax: 22, armorEff: 0.8, pierce: 0.3, ap: 4, br: 10, br_tax: 1 } }),
    P("zhou", "周大刀", "关", { hpMax: 60, skill: 58, def: 6, shield: 0, resolve: 47,
      initBase: 93, breathBase: 90, armor: "pijia", helmet: "pikui",
      wpn: { kind: "melee", label: "大关刀", hands: 2, acc: 8, dmin: 28, dmax: 42, armorEff: 1.2, pierce: 0.3, ap: 6, br: 17, br_tax: 6, chop: true, bleed: true, special: { type: "sweep", label: "横扫", ap: 6, br: 20, acc: -10 } } }),
    ...
    E("zuanshan", "钻山豹", "戟", { hpMax: 54, skill: 55, def: 6, shield: 0, resolve: 41,
      ...
      wpn: { kind: "melee", label: "戟", hands: 2, reach: 2, acc: 12, dmin: 22, dmax: 32, armorEff: 1.0, pierce: 0.35, ap: 6, br: 15, br_tax: 5, special: { type: "sweep", label: "横扫", ap: 6, br: 20, acc: -10 } } }),
    // ---- the hardened line (会战 roster): the two-camp host's real soldiers ----
    E("hfa", "悍匪·甲", "匪", { hpMax: 52, skill: 56, def: 6, shield: 0, resolve: 45,
      initBase: 99, breathBase: 88, armor: "pijia", helmet: "bumao",
      wpn: { kind: "melee", label: "长枪", hands: 2, reach: 2, acc: 20, dmin: 22, dmax: 32, armorEff: 0.9, pierce: 0.3, ap: 6, br: 15, br_tax: 4, special: { type: "spearwall", label: "枪林", ap: 3, br: 18 } } }),
    E("hfb", "悍匪·乙", "匪", { hpMax: 52, skill: 55, def: 6, shield: 0, resolve: 44,
      initBase: 98, breathBase: 88, armor: "pijia", helmet: "bumao",
      wpn: { kind: "melee", label: "长枪", hands: 2, reach: 2, acc: 20, dmin: 22, dmax: 32, armorEff: 0.9, pierce: 0.3, ap: 6, br: 15, br_tax: 4, special: { type: "spearwall", label: "枪林", ap: 3, br: 18 } } }),
    E("hfc", "悍匪·丙", "匪", { hpMax: 54, skill: 56, def: 6, shield: 10, resolve: 45,
      initBase: 97, breathBase: 87, armor: "pijia", helmet: "pikui",
      wpn: { kind: "melee", label: "砍刀", hands: 1, acc: 10, dmin: 17, dmax: 26, armorEff: 1.0, pierce: 0.3, ap: 4, br: 12, br_tax: 2, bleed: true, special: { type: "decap", label: "斩首", ap: 5, br: 15, dmgMult: 1.3 } } }),
    E("hfd", "悍匪·丁", "匪", { hpMax: 54, skill: 55, def: 6, shield: 10, resolve: 44,
      initBase: 96, breathBase: 87, armor: "pijia", helmet: "pikui",
      wpn: { kind: "melee", label: "短矛", hands: 1, acc: 15, dmin: 16, dmax: 24, armorEff: 0.9, pierce: 0.25, ap: 4, br: 11, br_tax: 2, special: { type: "spearwall", label: "枪阵", ap: 3, br: 16 } } }),
    E("hfe", "悍匪·弓", "弓", { hpMax: 44, skill: 52, def: 5, shield: 0, resolve: 39,
      initBase: 107, breathBase: 90, armor: "bujia", helmet: "bumao",
      wpn: { kind: "ranged", label: "猎弓", hands: 2, acc: 10, dmin: 14, dmax: 24, armorEff: 0.6, pierce: 0.35, ap: 4, br: 8, br_tax: 2, range: 7, falloff: 3, special: { type: "aimed", label: "瞄准", ap: 6, br: 12, accBonus: 10, falloff: 2 } },
      wpn2: { kind: "melee", label: "短刀", hands: 1, acc: 0, dmin: 14, dmax: 22, armorEff: 0.8, pierce: 0.3, ap: 4, br: 10, br_tax: 1 } }),
    E("lla", "喽啰·甲", "卒", { hpMax: 40, skill: 46, def: 3, shield: 0, resolve: 30,
      initBase: 102, breathBase: 85, armor: "bujia", helmet: "none_h",
      wpn: { kind: "melee", label: "短刀", hands: 1, acc: 0, dmin: 14, dmax: 22, armorEff: 0.8, pierce: 0.3, ap: 4, br: 10, br_tax: 1 } }),
...
function renderInspect(u) {
  ...
  el.innerHTML =
    ...
    `兵器 ${qSpan(w.label, w.quality)}：伤 ${w.dmin}–${w.dmax} ｜ 破甲 ${Math.round(w.armorEff * 100)}% ｜ 穿甲 ${Math.round(w.pierce * 100)}%` +
