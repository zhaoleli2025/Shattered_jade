...
ROSTER = [
    ...
    dict(id="xya", name="乡勇·甲", glyph="勇", side="player", hp_max=42, skill=47, dfn=4,
         shield=0, resolve=34, init_base=99, breath_base=86, armor="bujia", helmet="bumao",
         wpn="changqiang", wpn2=None),
    dict(id="xyb", name="乡勇·乙", glyph="勇", side="player", hp_max=42, skill=46, dfn=4,
         shield=0, resolve=33, init_base=98, breath_base=86, armor="bujia", helmet="bumao",
         wpn="changqiang", wpn2=None),
    dict(id="xyc", name="乡勇·丙", glyph="勇", side="player", hp_max=44, skill=46, dfn=4,
         shield=10, resolve=34, init_base=97, breath_base=85, armor="bujia", helmet="bumao",
         wpn="duanmao", wpn2=None),
    dict(id="xyd", name="乡勇·丁", glyph="勇", side="player", hp_max=44, skill=45, dfn=4,
         shield=10, resolve=33, init_base=96, breath_base=85, armor="bujia", helmet="bumao",
         wpn="duanmao", wpn2=None),
    ...
    dict(id="hfa", name="悍匪·甲", glyph="匪", side="enemy", hp_max=52, skill=56, dfn=6,
         shield=0, resolve=45, init_base=99, breath_base=88, armor="pijia", helmet="bumao",
         wpn="changqiang", wpn2=None),
    dict(id="hfb", name="悍匪·乙", glyph="匪", side="enemy", hp_max=52, skill=55, dfn=6,
         shield=0, resolve=44, init_base=98, breath_base=88, armor="pijia", helmet="bumao",
         wpn="changqiang", wpn2=None),
    dict(id="hfc", name="悍匪·丙", glyph="匪", side="enemy", hp_max=54, skill=56, dfn=6,
         shield=10, resolve=45, init_base=97, breath_base=87, armor="pijia", helmet="pikui",
         wpn="kandao", wpn2=None),
    dict(id="hfd", name="悍匪·丁", glyph="匪", side="enemy", hp_max=54, skill=55, dfn=6,
         shield=10, resolve=44, init_base=96, breath_base=87, armor="pijia", helmet="pikui",
         wpn="duanmao", wpn2=None),
    dict(id="hfe", name="悍匪·弓", glyph="弓", side="enemy", hp_max=44, skill=52, dfn=5,
         shield=0, resolve=39, init_base=107, breath_base=90, armor="bujia", helmet="bumao",
         wpn="liegong", wpn2="duandao"),
    ...
    dict(id="xiangwen", name="耶律详稳", glyph="辽", side="enemy", hp_max=68, skill=63, dfn=12,
         shield=15, resolve=58, init_base=95, breath_base=92, armor="tiejia", helmet="tiekui",
         wpn="jiuhuandao", wpn2=None, leader=True),
    dict(id="psa", name="皮室·甲", glyph="辽", side="enemy", hp_max=60, skill=59, dfn=7,
         shield=0, resolve=52, init_base=94, breath_base=92, armor="tiejia", helmet="tiekui",
         wpn="changqiang", wpn2=None),
    dict(id="psb", name="皮室·乙", glyph="辽", side="enemy", hp_max=60, skill=58, dfn=7,
         shield=0, resolve=51, init_base=93, breath_base=92, armor="tiejia", helmet="tiekui",
         wpn="changqiang", wpn2=None),
    dict(id="psc", name="皮室·丙", glyph="辽", side="enemy", hp_max=62, skill=58, dfn=7,
         shield=0, resolve=52, init_base=92, breath_base=91, armor="tiejia", helmet="tiekui",
         wpn="dafu", wpn2=None),
    dict(id="psd", name="皮室·丁", glyph="辽", side="enemy", hp_max=62, skill=57, dfn=7,
         shield=0, resolve=51, init_base=91, breath_base=93, armor="tiejia", helmet="tiekui",
         wpn="dachui", wpn2=None),
    dict(id="sda", name="射雕手·甲", glyph="弓", side="enemy", hp_max=48, skill=57, dfn=6,
         shield=0, resolve=44, init_base=110, breath_base=92, armor="pijia", helmet="bumao",
         wpn="liegong", wpn2="duandao"),
    dict(id="sdb", name="射雕手·乙", glyph="弓", side="enemy", hp_max=48, skill=56, dfn=6,
         shield=0, resolve=43, init_base=109, breath_base=92, armor="pijia", helmet="bumao",
         wpn="liegong", wpn2="duandao"),
    dict(id="hqa", name="汉军枪手·甲", glyph="枪", side="enemy", hp_max=50, skill=53, dfn=5,
         shield=0, resolve=42, init_base=98, breath_base=88, armor="pijia", helmet="pikui",
         wpn="changqiang", wpn2=None),
    dict(id="hqb", name="汉军枪手·乙", glyph="枪", side="enemy", hp_max=50, skill=52, dfn=5,
         shield=0, resolve=41, init_base=97, breath_base=88, armor="pijia", helmet="pikui",
         wpn="changqiang", wpn2=None),
    dict(id="hqc", name="汉军枪手·丙", glyph="枪", side="enemy", hp_max=52, skill=53, dfn=5,
         shield=12, resolve=42, init_base=96, breath_base=87, armor="pijia", helmet="pikui",
         wpn="duanmao", wpn2=None),
    dict(id="hna", name="汉军弩手·甲", glyph="弩", side="enemy", hp_max=46, skill=53, dfn=5,
         shield=0, resolve=41, init_base=99, breath_base=89, armor="pijia", helmet="bumao",
         wpn="nu", wpn2="duandao"),
    dict(id="hnb", name="汉军弩手·乙", glyph="弩", side="enemy", hp_max=46, skill=52, dfn=5,
         shield=0, resolve=40, init_base=98, breath_base=89, armor="pijia", helmet="bumao",
         wpn="nu", wpn2="duandao"),
]
